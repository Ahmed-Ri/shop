...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="box-shadow: 1px 2px 4px 1px rgba(0,0,0,0.2);">
        ...
        <div class="btn-group ml-auto" role="group" aria-label="Tableaux-Graphiques">
            <a href="#" class="btn btn-secondary btn-fixed-width" id="btnTableaux"data-href-depenses="/liste/depenses" data-href-recettes="/liste/recettes" data-href-RecettesDepenses="/liste/RecetteDepense">Liste</a>
            <a href="#" class="btn btn-secondary btn-fixed-width" id="btnGraphiques"data-href-depenses="/graphique/depenses" data-href-recettes="/graphique/recettes" data-href-RecettesDepenses="/graphique/RecetteDepense">Graph</a>
        </div>
...
$(function() {
    ...
    $('input[name="daterange"]').daterangepicker({
        ...
        $('input[name="daterange"]').data('daterangepicker').setStartDate(start.format('DD/MM/YYYY'));
