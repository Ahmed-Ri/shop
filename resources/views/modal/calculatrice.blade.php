...
<div class="modal fade" id="modalCalculatrice" tabindex="-1" aria-labelledby="modalCalculatriceLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mr-5">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalCalculatriceLabel">Calculatrice</h5>
                ...
                <style>
                 ...
                 .modal-dialog{
                    ...
                    .calc {
                        ...
                        border-left-color: rgb(159,159, 157, 157);
                        border-bottom-color: rgb(111,111, 111, 112);
