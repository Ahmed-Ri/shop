...
<div class="modal fade" id="exampleModalToggleRetour" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        ...
        <div id="modal-content-style" class="modal-content">
            ...
            <div class="modal-footer d-flex flex-column align-items-center mt-2">
                 ...
                 <form action="{{ route('retour_Montant_Libre') }}" method="post">
                    ...
                    <input type="text" class="form-control my-2" name="montant" placeholder="Montant de retour" required>
